...
# About me.
I am an AI enthusiast. I recently explore some projects include:
...
My continouous interest is at Chatbot for mental health support which is kindly supported by [[to be confirmed]] for using resources in computation. Hopefully I could share some of my results here soon.

However, I am a speech researcher experienced in Thai TTS and a member of the ISCA reviewer community. My latest research explores cross-lingual transfer, specifically using teacher models to bridge the gap for low-resource languages in Qwen3-TTS..
